...
class SpellCheckGUI(QWidget):
	...
	def return_result(self,word):
		...
		tword = ''
		if(self.eq == 0):
			tword = "<span style=\"color:#FF0000;\" >" + word + "</span>" #insert html style for each word
			self.tbox.insertHtml(tword)
		else:
			tword = "<span style=\"color:#000000;\" >" + word + "</span>"
			self.tbox.insertHtml(tword) #insert the result
